...
declare namespace FudgeCore {
    ...
    abstract class Serializer {
        ...
        static getConstructor<T extends Serializable>(
            _path: string
        ): new () => T;
        /**
...
declare namespace FudgeCore {
    ...
    class RenderInjectorMesh {
        ...
        protected static deleteRenderBuffers(
...
declare namespace FudgeCore {
    ...
    abstract class Framing extends Mutable {
         ...
         */
        abstract getPoint(
            _pointInFrame: Vector2,
            _rectFrame: Rectangle
        ): Vector2;
        /**
...
declare namespace FudgeCore {
    ...
    class MeshTerrain extends Mesh {
        ...
        constructor(
            _name?: string,
            source?: HeightMapFunction | TextureImage,
            _resolutionX?: number,
            _resolutionZ?: number
        );
...
declare namespace FudgeCore {
    ...
    abstract class Project {
        ...
        static clear(): void;
        static getResourcesOfType<T>(
            _type: new (_args: General) => T
        ): Resources;
        /**
